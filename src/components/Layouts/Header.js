      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
          ...
          >
            <img
              src={Logo}
              className="stroke-1 mr-4 h-16 sm:h-12"
              alt="Learnify Logo"
            />
            <span className="font-serif hover:font-mono self-center text-2xl font-semibold text-gray-700 whitespace-nowrap dark:text-white">
              Learnify
            </span>
          </Link>
            ...
            <div className="relative inline-block">
              <span onClick={() => setDarkMode(!darkMode)}>
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="cursor-pointer text-xl text-gray-700 size-6 hover:font-mono dark:text-white  bi-gear-wide-connected"
                >
