...
export const FilterBar = ({setShow}) => {
            ...
            <div className="py-4 overflow-y-auto">
                <ul className="text-slate-700 dark:text-slate-100">
                  ...
                  <li className="mt-1 mb-5">
                    ...
                    <div className="flex items-center my-1">
                        <input onChange={()=>dispatch({type:"RATINGS",
  ...
  payload: { bestSellerOnly: !state.bestSellerOnly }
                           ...
                           id="best-seller" checked={state.bestSellerOnly||false} type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
  ...
  payload: { onlyInStock: !state.onlyInStock }
                        ...
                        id="only-instock" checked={state.onlyInStock||false} type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
